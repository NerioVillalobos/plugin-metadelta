> **Last update / Última actualización:** 2025-12-02 — `@nervill/metadelta` 0.9.1
...
2. Install the plugin directly from GitHub using the Salesforce CLI:
   ...
   ```
   Confirm installation with `sf plugins`, which should list `@nervill/metadelta 0.9.1`.
...
4. Link the plugin to your local Salesforce CLI:
   ...
   sf plugins link .
   ```
   Confirm installation with `sf plugins`, which should list `@nervill/metadelta 0.9.1 (link)`.
