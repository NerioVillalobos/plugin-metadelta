import {Command} from '../../utils/oclif.js';
...
class Initspace extends Command {
  ...
  static description =
    'Creates the standard Metadelta folder structure and base files (.gitignore, sfdx-project.json, package.xml) in the current directory.';
