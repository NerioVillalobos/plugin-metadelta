...
class MetadeltaSecurityUsers extends Command {
  ...
  static flags = {
    ...
    'output-dir': Flags.string({summary: 'Directorio de salida para los CSV generados. En --validate, si se indica un valor distinto de out, se crea la carpeta out dentro de esa ruta.', default: 'out'}),
  ...
  resolveOutputDir(flags) {
    ...
    if (flags.validate && configuredOutputDir !== 'out') {
