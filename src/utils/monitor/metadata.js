...
const pathTypeMap = [
  ...
  {pattern: /(^|\/)omniIntegrationProcedures\//i, type: 'IntegrationProcedure', field: 'Name', source: 'vlocity'},
...
function vlocityMemberName(file, type) {
  ...
  return stripSourceSuffix(path.basename(file)).replace(/_AllRelationshipKeys$/i, '');
}
