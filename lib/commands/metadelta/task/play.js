...
async function clickAgentforceAgentsLink(page, options = {}) {
  ...
  // Compatibilidad con la estrategia "legacy" que funcionaba en versiones previas:
  // buscar por Quick Find, recargar una vez y volver a intentar antes de activar
  // las rutas de recuperación más agresivas.
