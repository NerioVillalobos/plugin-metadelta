...
const DEFAULT_SOLUTIONS = [
    ...
    },
    {
        ...
        solution: 'Reejecuta con consola visible y prueba manualmente: "npx playwright codegen <url> --target playwright-test --output tests/<archivo>.ts". Si falla por binarios, ejecuta "npx playwright install chromium".',
    },
];
...
export function ensurePlaywrightReady() {
    ...
    if (!hasPlaywrightBrowsers()) {
        throw new Error('No se pudieron instalar o validar los navegadores de Playwright automáticamente. Ejecuta "npx playwright install chromium" y reintenta.');
    }
}
